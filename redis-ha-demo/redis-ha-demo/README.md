...
├── package.json
├── redis/
│   ├── master.conf           # aster konfiguracija
...
> ⚠️ Zahteva Docker. Na Windows sa lokalnim Redis-om failover se može simulirati ručnim zatvaranjem Master CMD prozora.
...
| Write ops/sec (pipeline 100) | ~120,000 |
| Read ops/sec | ~95,000 |
